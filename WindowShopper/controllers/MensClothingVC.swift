...
class MensClothingVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
        ...
        if(Connectivity.isConnectedToNetwork()){
            ...
            mRef.child("inventory").observe(.value) { (snapshot) in
                ...
                for item in snapshot.children.allObjects as! [DataSnapshot]{
                    ...
                    let sizes = itemDict?["sizes"] as! Dictionary<String,Int>
                    
                    let clothes = Clothes(id: id, category: category, title: title, summary: summary, price: price, image: image, specifics: specifics, sizes: sizes)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return mShirtsList.count + mJacketsList.count + mPantsList.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            ...
            break;
        case 1:
            item = mJacketsList[indexPath.row]
            break;
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case 0:
            ...
            break;
        case 1:
            itemSelected = mJacketsList[indexPath.row]
            break;
